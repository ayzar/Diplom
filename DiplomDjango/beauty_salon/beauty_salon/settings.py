...
SECRET_KEY = 'django-insecure-l!&maj2mphiwebh$62_(+glv^w$toov9h9^niw9+s&c)ia-h=d'
...
# Путь для хранения статических файлов, собранных командой collectstatic
...
LOGIN_REDIRECT_URL = 'profile'  # Личный кабинет после авторизации
